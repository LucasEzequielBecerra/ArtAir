...
//                 resolve(findProduct)
//                 :
//                 rejected("Error leyendo los datos")
//         }, 1000)
//     });
// }

// export function getProductsByCategory(itemCategoryUrl) {
//     return new Promise((resolve, rejected) => {
//         setTimeout(() => {
//             let filteredProducts = arrProductos.filter((item) => item.category === itemCategoryUrl)
